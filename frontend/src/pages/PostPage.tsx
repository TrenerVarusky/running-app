...
function Paragraphs({ text }: { text: string }) {
	...
	return (
		<>
			{parts.map((p, i) => (
				<p key={i} className="leading-7 text-white/90 mb-4 whitespace-pre-wrap">
					{p}
				</p>
			))}
		</>
		...
		<div className="flex min-h-screen flex-col bg-gray-900 text-white">
			...
			<main className="flex-grow pt-24 py-12 pb-16">
				<div className="max-w-5xl mx-auto px-4">
					...
					{post && (
						<article className="bg-gray-800 rounded-2xl shadow-lg">
							{/* Hero */}
							{post.hero_image_url && (
								<div className="w-full max-h-[600px] overflow-hidden rounded-2xl shadow-lg ">
									<img
