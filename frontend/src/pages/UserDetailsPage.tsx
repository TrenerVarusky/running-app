...
const UserDetailsPage = () => {
	...
	return (
      ...
      <LogoutButton />
			...
			<main className="flex-grow py-36 px-4">
				<div className="max-w-2xl mx-auto bg-gray-800 p-8 rounded-xl shadow-lg">
					<h2 className="text-2xl font-bold mb-6">Szczegóły użytkownika Details(obecnie nie ma)</h2>
					<form onSubmit={handleSubmit} className="space-y-4">
						...
						<button type="submit" className="mt-4 bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded">
							Zapisz dane
						</button>
					</form>
				</div>
